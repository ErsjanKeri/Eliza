...
package com.example.ai.edge.eliza.core.data.auth

import androidx.core.net.toUri
import net.openid.appauth.AuthorizationServiceConfiguration

object AuthConfig {
  // HuggingFace Client ID (copied from Gallery)
  const val clientId = "88a0ac25-fcf4-467b-b8cd-ebcc2aec9bd0"
  
  // Registered redirect URI for Eliza
  // The scheme needs to match the
  // "android.defaultConfig.manifestPlaceholders["appAuthRedirectScheme"]" field in
  // "build.gradle.kts".
  const val redirectUri = "com.example.ai.edge.eliza.oauth://oauthredirect"
